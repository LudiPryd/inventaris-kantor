                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control @error('tgl_pembelian') is-invalid @enderror" name="tgl_pembelian" value="{{ old('tgl_pembelian') }}" placeholder="Masukkan Stock Product">
